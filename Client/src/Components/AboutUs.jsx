                    ...
                    <div className="flex flex-wrap ">
                        <div className="  px-4 mb-10 lg:w-1/2 lg:mb-0">
                            <div className="relative lg:max-w-md">
                                <img
                                    src="https://img.freepik.com/free-photo/business-people-teamwork_53876-89051.jpg?w=1060&t=st=1685099940~exp=1685100540~hmac=c1d6779dffda31f042be57722878f30c4a9b05d2ab258316c8ea4ea4ee6255e4"
                                    alt="aboutimage"
                                    className="relative z-10 object-cover w-full lg:rounded-tr-[80px] lg:rounded-bl-[80px] h-96"
                                />
                                <div className="absolute text-black bottom-0 right-0 z-10 p-8 bg-white border-4 border-blue-500 rounded shadow dark:border-blue-400 lg:-mb-8 lg:-mr-11 sm:p-8 dark:text-gray-300 dark:bg-gray-800 ">
