...
const AboutUs = () => {
    ...
    return (
        <div className=''>
            <section className="flex items-center mt-16 bg-gradient-to-b from-[#3E4C5A] via-[#3E4C5A] to-gray-300 xl:h-screen font-poppins dark:bg-gray-800 ">
                    ...
                    <div className="flex flex-wrap ">
                        ...
                        <div className=" px-6 mb-10 lg:w-1/2 lg:mb-0 ">
                            <div className="pl-4 mb-6 border-l-4 border-yellow-300/90 ">
                                <span className="text-4xl text-gray-400 uppercase dark:text-gray-400">
                                    من نحن ؟
                                </span>
                                <h1 className="mt-8 text-3xl font-black text-white md:text-5xl dark:text-gray-300">
                                    منصة عَ الطريق
                                </h1>
                            </div>
                            <p className="mb-6 mt-10 py-5 text-base leading-7 text-white dark:text-gray-400">
