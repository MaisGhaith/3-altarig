                                                ...
                                                <div className="mb-12 max-w-[570px] lg:mb-0 ">
                                                    ...
                                                    <div className="mb-8 flex w-full max-w-[370px]">
                                                        ...
                                                        <div className="w-full">
                                                            ...
                                                            <p className="text-body-color text-base">
                                                                <a href="mailto:mais.ghaith972000@gmail.com">mais.ghaith972000@gmail.com</a>
                                                            </p>
                                                        </div>
                                                ...
                                                <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                                                    <form>
                                                        ...
                                                        <div>
                                                            <button
                                                                type="submit"
                                                                className="animate-bounce bg-black border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                                                            >
                                                                إرسال
                                                            </button>
                                                        </div>
